...
def make_minimal_run(run_dir: Path) -> None:
    ...
    outputs = {
        ...
        "dashboard_html": str(run_dir / "dashboard.html"),
    ...
    write_text(Path(outputs["dashboard_html"]), "<!doctype html><html><body>window.DASHBOARD_DATA dashboard_data.json fake_run</body></html>")
